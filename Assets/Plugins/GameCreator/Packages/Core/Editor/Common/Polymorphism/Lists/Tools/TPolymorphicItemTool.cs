...
namespace GameCreator.Editor.Common
{
    public abstract class TPolymorphicItemTool : VisualElement, IPolymorphicItemTool
    {
        ...
        public const string CLASS_DROP = "gc-list-item-drop";
        ...
        protected TPolymorphicItemTool(IPolymorphicListTool parentTool, int propertyIndex)
        {
            ...
            {
                this.AddManipulator(new PolymorphicItemDrop(this));   
            }
        ...
        private void SetupHeadReordering()
        {
            ...
            this.m_HeadDrag.AddManipulator(new PolymorphicItemDrag(this));
        ...
        {
            PropertyField fieldBody = new PropertyField
            {
                label = string.Empty
            };

            fieldBody.BindProperty(this.m_Property);
            fieldBody.RegisterValueChangeCallback(change => this.UpdateHead());
        ...
        {
            this.DropAbove.AddToClassList(CLASS_DROP);
            this.DropBelow.AddToClassList(CLASS_DROP);

            this.Insert(0, this.DropAbove);
            this.Insert(3, this.DropBelow);
        }
            ...
            if (this.ParentTool.AllowCopyPaste)
            {
                ...
                menu.menu.AppendAction(
                    ...
                    action =>
                    {
                        ...
                        this.ParentTool.InsertItem(pasteIndex, CopyPasteUtils.SourceObject);
                    },
