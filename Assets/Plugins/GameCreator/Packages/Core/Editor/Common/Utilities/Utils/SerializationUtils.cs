...
namespace GameCreator.Editor.Common
{
    public static class SerializationUtils
    {
            ...
            bool hideLabelsInChildren, bool indent, params string[] excludeFields)
        {
            ...
            do
            {
                ...
                PropertyField field = hideLabelsInChildren
                    ...
                    : new PropertyField(iteratorProperty, Label(iteratorProperty, indent));
        ...
        private static string Label(SerializedProperty property, bool indent)
        {
            return indent
                ? INDENT + property.displayName
