...
namespace GameCreator.Runtime.Characters
{
    ...
    public class StateBasicLocomotion : StateOverrideAnimator
    {
        ...
        [SerializeField] private Crouch8Points m_Crouch8Points = new Crouch8Points();
        ...
        protected sealed override void BeforeSerialize()
        {
            ...
            this.m_Controller[N_STAND_BR]   = this.m_Stand8Points.m_BackwardRight;
            this.m_Controller[N_STAND_BL]   = this.m_Stand8Points.m_BackwardLeft;
            this.m_Controller[N_CROUCH_IDLE] = this.m_Crouch8Points.m_Idle;
            this.m_Controller[N_CROUCH_F]    = this.m_Crouch8Points.m_Forward;
            this.m_Controller[N_CROUCH_B]    = this.m_Crouch8Points.m_Backward;
            this.m_Controller[N_CROUCH_R]    = this.m_Crouch8Points.m_Right;
            this.m_Controller[N_CROUCH_L]    = this.m_Crouch8Points.m_Left;
            this.m_Controller[N_CROUCH_FR]   = this.m_Crouch8Points.m_ForwardRight;
            this.m_Controller[N_CROUCH_FL]   = this.m_Crouch8Points.m_ForwardLeft;
            this.m_Controller[N_CROUCH_BR]   = this.m_Crouch8Points.m_BackwardRight;
            this.m_Controller[N_CROUCH_BL]   = this.m_Crouch8Points.m_BackwardLeft;
            this.m_Controller[N_CROUCH_F]    = this.m_Crouch8Points.m_Forward;
            this.m_Controller[N_CROUCH_B]    = this.m_Crouch8Points.m_Backward;
            this.m_Controller[N_CROUCH_R]    = this.m_Crouch8Points.m_Right;
            this.m_Controller[N_CROUCH_L]    = this.m_Crouch8Points.m_Left;
