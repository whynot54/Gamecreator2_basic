...
namespace GameCreator.Runtime.Characters
{
    ...
    public class StateCompleteLocomotion : StateOverrideAnimator
    {
        ...
        [SerializeField] private Crouch16Points m_Crouch16Points = new Crouch16Points();
        ...
        protected sealed override void BeforeSerialize()
        {
            ...
            this.m_Controller[N_CROUCH_IDLE]    = this.m_Crouch16Points.m_Idle;
            this.m_Controller[N_CROUCH_FAST_F]  = this.m_Crouch16Points.m_ForwardFast;
            this.m_Controller[N_CROUCH_FAST_B]  = this.m_Crouch16Points.m_BackwardFast;
            this.m_Controller[N_CROUCH_FAST_R]  = this.m_Crouch16Points.m_RightFast;
            this.m_Controller[N_CROUCH_FAST_L]  = this.m_Crouch16Points.m_LeftFast;
            this.m_Controller[N_CROUCH_FAST_FR] = this.m_Crouch16Points.m_ForwardRightFast;
            this.m_Controller[N_CROUCH_FAST_FL] = this.m_Crouch16Points.m_ForwardLeftFast;
            this.m_Controller[N_CROUCH_FAST_BR] = this.m_Crouch16Points.m_BackwardRightFast;
            this.m_Controller[N_CROUCH_FAST_BL] = this.m_Crouch16Points.m_BackwardLeftFast;
            this.m_Controller[N_CROUCH_SLOW_F]  = this.m_Crouch16Points.m_ForwardSlow;
            this.m_Controller[N_CROUCH_SLOW_B]  = this.m_Crouch16Points.m_BackwardSlow;
            this.m_Controller[N_CROUCH_SLOW_R]  = this.m_Crouch16Points.m_RightSlow;
            this.m_Controller[N_CROUCH_SLOW_L]  = this.m_Crouch16Points.m_LeftSlow;
            this.m_Controller[N_CROUCH_SLOW_FR] = this.m_Crouch16Points.m_ForwardRightSlow;
            this.m_Controller[N_CROUCH_SLOW_FL] = this.m_Crouch16Points.m_ForwardLeftSlow;
            this.m_Controller[N_CROUCH_SLOW_BR] = this.m_Crouch16Points.m_BackwardRightSlow;
            this.m_Controller[N_CROUCH_SLOW_BL] = this.m_Crouch16Points.m_BackwardLeftSlow;
